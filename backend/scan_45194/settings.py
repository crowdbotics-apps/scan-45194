"""
Django settings for scan_45194 project.
...
WSGI_APPLICATION = 'scan_45194.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "scan_45194 API",
    "DESCRIPTION": "API documentation for scan_45194 App",
    "VERSION": "v1",
}
